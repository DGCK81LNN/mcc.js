import { Logger, ConsoleLogger, LogLevel } from './Logging';
import { ChatBot } from './ChatBot';
import { AuthenticateCommand, ChangeSessionIdCommand } from './Commands';
...
export class MccJsClient {
    ...
    private handleEvent(event: string, data: any): void {
        ...
        // This is useful when the MCC hasn't been updated to support all the events from Web Socket Chat Bot
        // or when you want to handle events in a custom way, 
        // or you're using an older version of MCC and want to catch new events without updating
